...
## timestamp: 2021-01-24 17:35:20 
## Wall clock time: 0.03866959 secs 
## optimizer:  SLSQP 
...
## To get additional fit indices, see help(mxRefModels)
## timestamp: 2021-01-24 17:35:22 
## Wall clock time: 0.03303933 secs 
## optimizer:  SLSQP 
## OpenMx version number: 2.18.1 
## Need help?  See help(mxSummary)
\end{verbatim}
...
## 5   x1 with   x1       sigma[x[1]]^2
## 6   x2 with   x2       sigma[x[2]]^2
## 7    y   on    1             beta[0]
## 8   x1   on    1            mu[x[1]]
## 9   x2   on    1            mu[x[2]]
## 
