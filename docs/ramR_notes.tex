...
\begin{figure}
\centering
\includegraphics{ramR_notes_files/figure-latex/regression-01-1.pdf}
...
\NormalTok{  ramR}\SpecialCharTok{::}\FunctionTok{mutheta}\NormalTok{(}
\NormalTok{    m,}
...
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(}
\NormalTok{  ramR}\SpecialCharTok{::}\FunctionTok{Sigmatheta}\NormalTok{(}
    \AttributeTok{A =}\NormalTok{ A,}
...
\begin{figure}
\centering
\includegraphics{ramR_notes_files/figure-latex/regression-02-1.png}
