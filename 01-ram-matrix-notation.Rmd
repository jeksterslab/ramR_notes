...
\noindent The `ramR::mutheta()` function can be used
...
\noindent The `ramR::Sigmatheta()` function can be used
...
\noindent The `ramR::m()` function can be used
...
\noindent The `ramR::Omega()` function can be used
