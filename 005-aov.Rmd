...
u <- matrix(
  data = c(
    ...
    paste(expression(mu[x[1]])),
    paste(expression(mu[x[2]])),
    0
  )
)
v <- matrix(
  data = c(
    paste(expression(beta[0] + beta[1] * mu[x[1]] + beta[2] * mu[x[2]])),
    paste(expression(mu[x[1]])),
    paste(expression(mu[x[2]])),
    0
  )
...
diag(S) <- c(
  0,
  paste(expression(sigma[x[1]]^2)),
  paste(expression(sigma[x[2]]^2)),
